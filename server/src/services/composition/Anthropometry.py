...
from server.src.services.composition.constants import DAYS_PER_YEAR, FFMI_HEIGHT_REF_M
...
def compute_ffmi_adjusted(ffmi: float, height_cm: float) -> float:
    height_m = height_cm / 100
    return ffmi + 6.3 * (FFMI_HEIGHT_REF_M - height_m)
